...
'''
This script is to generate a json file to summarize Wiki talk page data for academics and politicians.

'''

input_file = "" # Enter a json file name of grouped talk page info. E.g: "wiki_talk_groups_politicians.json" under "data/talkpage"


output_file = "" #Enter desired output file name or path here (.json)
				# one example of desired output is "data/talkpage/wiki_talk_stats_politicians.json"
...
with open("../data/talkpage/treated_main_metric.csv") as csvfile:
...
f = open("../data/talkpage/"+input_file,"r")
